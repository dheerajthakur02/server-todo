...
import dotenv from 'dotenv';
import TodoModel from './Models/Todo.js'; // Adjust path as needed
import serverless from 'serverless-http';  // Add this import for serverless compatibility
...
export default serverless(app);  // This is the serverless handler function
